...
export function MobileView({
  ...
  const steps = [
    ...
    { number: 3, title: 'เซ็นสัญญา', icon: FileText },
    { number: 4, title: 'รับเงิน', icon: DollarSign },
    { number: 5, title: 'ค่าใช้จ่าย', icon: Receipt },
  ]
          ...
          <div className="space-y-6">
            ...
            <Card className="p-6 shadow-sm">
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-2">
                  <Label htmlFor="startFuel" className="text-sm font-medium">
                    ระดับน้ำมัน (1-8)
                  </Label>
                  <div className="flex items-center gap-3">
            ...
            <Card className="p-6 shadow-sm">
              ...
              <p className="text-xs text-muted-foreground mb-4">
                แตะบริเวณที่มีความเสียหายเพื่อบันทึก
              </p>
                ...
                <div className="mt-4 p-4 border-2 border-primary/30 bg-primary/5 rounded-lg space-y-3">
                  <div className="flex items-center justify-between">
                    <h4 className="text-sm font-semibold">
                      บันทึกความเสียหาย: {selectedCarPart}
                    </h4>
              ...
              {damages.length > 0 && (
                <div className="mt-4 space-y-2">
                  <Label className="text-sm font-medium">
                    รายการความเสียหาย ({damages.length})
                  </Label>
              ...
              <div className="p-4 bg-card border-t">
                <div className="flex items-start gap-3">
                  ...
                  <Button
                    ...
                    onClick={() =>
                      window.open(
                        'https://www.google.com/maps/dir/?api=1&destination=13.744677,100.560704',
                        '_blank'
                      )
                    }
                  >
          ...
          <div className="space-y-6">
            ...
            <Card className="p-5 shadow-sm">
              <h3 className="text-base font-semibold mb-3">
                อัตราค่าปรับกรณีเกิดความเสียหาย
              </h3>
            ...
            <Card className="p-6 shadow-sm">
              ...
              <ScrollArea className="h-[400px] w-full rounded-lg border border-border p-4 bg-muted/30">
                <div className="text-sm leading-relaxed space-y-4">
                  <p className="font-semibold">
                    สัญญาเช่ารถยนต์ฉบับนี้ทำขึ้นระหว่าง บริษัท ABC เช่ารถ จำกัด ("ผู้ให้เช่า") และ
                    คุณสมชาย ใจดี ("ผู้เช่า") ตกลงทำสัญญาเช่ารถยนต์ดังต่อไปนี้
                  </p>

                  <div>
                    <p className="font-semibold mb-1">ข้อ 1: ข้อมูลรถยนต์</p>
                    <p>
                      ผู้ให้เช่าตกลงให้เช่า และผู้เช่าตกลงเช่ารถยนต์ยี่ห้อ Toyota รุ่น Camry
                      หมายเลขทะเบียน กก-1234 กรุงเทพมหานคร สีดำ เลขตัวถัง: ABC123456789
                    </p>
                  </div>
                  ...
                  <div>
                    ...
                    <p>
                      ระยะเวลาการเช่าตั้งแต่วันที่ 3 กุมภาพันธ์ 2026 เวลา 14:00 น. ถึงวันที่ 10
                      กุมภาพันธ์ 2026 เวลา 14:00 น. รวม 7 วัน
                    </p>
                  </div>
                  ...
                  <div>
                    ...
                    <p>
                      • ค่าเช่ารถ: 15,000 บาท (หนึ่งหมื่นห้าพันบาทถ้วน)
                      <br />
                      • ค่าส่งรถ: 500 บาท
                      <br />
                      • เงินประกัน: 10,000 บาท (คืนเมื่อส่งคืนรถในสภาพดี)
                      <br />• ยอดรวมทั้งสิ้น: 25,500 บาท
                    </p>
                  </div>
                  ...
                  <div>
                    ...
                    <p>
                      ผู้เช่าต้องวางเงินประกัน 10,000 บาท ซึ่งจะคืนให้เมื่อคืนรถในสภาพสมบูรณ์
                      หากรถเกิดความเสียหายระหว่างการเช่า ผู้ให้เช่ามีสิทธิหักเงินประกันเพื่อซ่อมแซม
                    </p>
                  </div>
                  ...
                  <div>
                    ...
                    <p>
                      • ผู้เช่าต้องรับผิดชอบในความเสียหายที่เกิดขึ้นกับรถขณะอยู่ในความครอบครอง
                      <br />
                      • ห้ามนำรถไปใช้ในทางที่ผิดกฎหมาย
                      <br />
                      • ห้ามให้บุคคลอื่นขับรถโดยไม่ได้รับอนุญาต
                      <br />• ต้องดูแลรถให้อยู่ในสภาพดี และตรวจเช็กน้ำมันเครื่องเป็นประจำ
                    </p>
                  </div>
                  ...
                  <div>
                    ...
                    <p>
                      • รอยขูดข่วน (A): 500-1,000 บาท
                      <br />
                      • รอยกระตุก-ตอก (B): 700-3,000 บาท
                      <br />
                      • รอยบุบเล็กน้อย (C): 500 บาท
                      <br />
                      • รอยบุบมาก (D): 1,000-3,000 บาท
                      <br />
                      • รอยริ้ว (E): 700-3,000 บาท
                      <br />• อื่นๆ (F): ตามราคาจริงในการซ่อม
                    </p>
                  </div>
                  ...
                  <div>
                    ...
                    <p>
                      ผู้เช่าต้องคืนรถในสภาพเดียวกับตอนรับรถ พร้อมน้ำมันเต็มถัง
                      หากคืนรถล่าช้ากว่าเวลาที่กำหนด จะมีค่าปรับชั่วโมงละ 500 บาท
                    </p>
                  </div>
                  ...
                  <div>
                    ...
                    <p>
                      หากผู้เช่าประสงค์จะยกเลิกสัญญา ต้องแจ้งล่วงหน้าอย่างน้อย 3 วัน
                      มิฉะนั้นจะถูกริบเงินมัดจำทั้งหมด
                    </p>
                  </div>
              ...
              >
                <span className="font-medium text-sm">
                  ข้าพเจ้าได้อ่านและเข้าใจสัญญาแล้ว
                </span>
                {contractRead ? (
              ...
              <div className="border-2 border-dashed rounded-lg p-6 bg-muted/20 min-h-32 flex items-center justify-center">
                {driverSignature ? (
                  <div className="text-center space-y-2">
                    ...
                    <Button variant="ghost" size="sm" onClick={() => setDriverSignature('')}>
                      เซ็นใหม่
                    </Button>
                  </div>
                ) : (
  ...
  return (
    <div className="min-h-screen bg-background pb-24">
      ...
      {/* Content */}
      <div className="container max-w-2xl mx-auto px-4">{renderStep()}</div>
